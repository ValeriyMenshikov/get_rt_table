SQL = {
    'REPS_CR_RES_RT': f"""select c_thrd_num, c_dog_index, c_dog_ref, c_debt_code,
    ...
    'REPS_RES_INFO_RT': """select t.c_prod_reserv, t.c_kind, t.c_summ_res, t.c_res_acc_ref, t.c_res_acc_num, t.c_debt_code,
    ...
    'REPS_DEBT_RT': """select t.c_dog_ref, t.c_acc_num, t.c_debt_code, t.c_line_ref, t.c_summ_debt#summ_rub, t.c_summ_debt#summ_val, t.c_date_close,
    ...
    'RT_NAVIGATOR': """SELECT C_1 Дата_расчета,
                             C_2 Филиал,
                             C_3 Заемщик,
                             C_4 Класс_клиента,
                             C_5 Тип_клиента,
